  ...
  <div>
    <el-container class="page-table-ctn">
      <div style="justify-content: space-between;">
        <el-input v-model="keyWord" class="searchinput" placeholder="请输入教师姓名/工号" prefix-icon="el-icon-search" clearable @input="mounted">
      ...
      <el-table :data="tableData" border>
        ...
        <el-table-column prop="id" label="操作">
          <template slot-scope="scope">
            ...
            <el-button @click="deleteTeacher(scope.row.id, scope.row.name, scope.row.number)" type="text" size="small"
